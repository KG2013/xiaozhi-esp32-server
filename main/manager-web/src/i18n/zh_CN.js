export default {
  ...
  'firmwareDialog.uploadHint': '温馨提示：请上传合并前的smhs.bin文件，而不是合并后的merged-binary.bin文件',
  ...
  'device.deviceBrand':'品牌',
  'device.deviceChannel':'渠道',
  'device.deviceSeries':'系列',
  'device.deviceType':'设备类型',
  'device.deviceModel':'型号',
  'device.deviceStatus':'状态',
  'device.deviceRemarks':'备注信息',
  'device.deviceCreateTime':'创建时间',
  'device.deviceUpdateTime':'更新时间',
