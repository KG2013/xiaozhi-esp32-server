        ...
        <div class="mcp-left">
          ...
          <div class="url-header">
            <div class="address-desc">
              ...
              <a href="https://github.com/xinnan-tech/smhs-esp32-server/blob/main/docs/mcp-endpoint-enable.md"
                target="_blank" class="doc-link">{{ $t('functionDialog.howToDeployMcp') }}</a> &nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="https://github.com/xinnan-tech/smhs-esp32-server/blob/main/docs/mcp-endpoint-integration.md"
