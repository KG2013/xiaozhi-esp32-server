...
export default {
  ...
  'settings.validServerUrl': 'Please enter a valid server address (starting with http or https and ending with /smhs)',
  ...
  // About us
  'settings.aboutApp': 'About Smhs Console',
  'settings.aboutContent': 'Smhs Console\n\nA cross-platform mobile management app built with Vue.js 3 + uni-app, providing device management, agent configuration and other functions for smhs ESP32 smart hardware.\n\n© 2025 smhs-esp32-server {version}',
  ...
  'deviceConfig.connectToXiaozhiHotspot': 'Please connect to smhs hotspot first',
  'deviceConfig.detecting': 'Detecting...',
  'deviceConfig.reDetect': 'Re-detect',
  'deviceConfig.alreadyConnected': 'Connected to smhs hotspot',
  ...
  'deviceConfig.bringPhoneCloseToXiaozhiDevice': 'Bring phone close to smhs device (1-2 meters distance)',
  'deviceConfig.duringAudioPlaybackXiaozhiWillReceive': 'During audio playback, smhs will receive and decode configuration information',
  ...
  'deviceConfig.smhs': 'smhs',
  'deviceConfig.connectXiaozhiHotspot': 'Please connect to smhs hotspot',
  ...
  'deviceConfig.connectedXiaozhiHotspot': 'Connected to smhs hotspot',
  ...
  'deviceConfig.pleaseDisconnectXiaozhiHotspot': 'Please disconnect from smhs hotspot',
  ...
  'deviceConfig.phoneConnectXiaozhiHotspot': 'Phone connect to smhs hotspot',
