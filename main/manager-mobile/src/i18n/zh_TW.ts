...
export default {
  ...
  'settings.validServerUrl': '請輸入有效的服務端地址（以 http 或 https 開頭，並以 /smhs 結尾）',
  ...
  'deviceConfig.connectToXiaozhiHotspot': '請先連接smhs熱點 (smhs-XXXXXX)',
  'deviceConfig.detecting': '檢測中...',
  'deviceConfig.reDetect': '重新檢測',
  'deviceConfig.alreadyConnected': '已連接smhs熱點',
  ...
  'deviceConfig.bringPhoneCloseToXiaozhiDevice': '將手機靠近smhs設備（距離1-2米）',
  'deviceConfig.duringAudioPlaybackXiaozhiWillReceive': '音頻播放時，smhs會接收並解碼配網信息',
  ...
  'deviceConfig.connectXiaozhiHotspot': '請連接smhs熱點',
  ...
  'deviceConfig.connectedXiaozhiHotspot': '已連接smhs熱點',
  ...
  'deviceConfig.pleaseDisconnectXiaozhiHotspot': '請斷開smhs熱點連接',
  ...
  'deviceConfig.phoneConnectXiaozhiHotspot': '手機連接smhs熱點',
