...
export default {
  ...
  'settings.validServerUrl': '请输入有效的服务端地址（以 http 或 https 开头，并以 /smhs 结尾）',
  ...
  'deviceConfig.connectToXiaozhiHotspot': '请先连接smhs热点 (smhs-XXXXXX)',
  'deviceConfig.detecting': '检测中...',
  'deviceConfig.reDetect': '重新检测',
  'deviceConfig.alreadyConnected': '已连接smhs热点',
  ...
  'deviceConfig.bringPhoneCloseToXiaozhiDevice': '将手机靠近smhs设备（距离1-2米）',
  'deviceConfig.duringAudioPlaybackXiaozhiWillReceive': '音频播放时，smhs会接收并解码配网信息',
  ...
  'deviceConfig.connectXiaozhiHotspot': '请连接smhs热点',
  ...
  'deviceConfig.connectedXiaozhiHotspot': '已连接smhs热点',
  ...
  'deviceConfig.pleaseDisconnectXiaozhiHotspot': '请断开smhs热点连接',
  ...
  'deviceConfig.phoneConnectXiaozhiHotspot': '手机连接smhs热点',
