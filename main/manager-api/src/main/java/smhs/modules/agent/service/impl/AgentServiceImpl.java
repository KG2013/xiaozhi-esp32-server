...
import smhs.common.utils.JsonUtils;
import smhs.modules.agent.dao.AgentDao;
...
import smhs.modules.agent.service.*;
...
import smhs.modules.model.dto.ModelProviderDTO;
import smhs.modules.model.dto.VoiceDTO;
import smhs.modules.model.entity.ModelConfigEntity;
import smhs.modules.model.service.ModelConfigService;
import smhs.modules.model.service.ModelProviderService;
import smhs.modules.security.user.SecurityUser;
import smhs.modules.sys.enums.SuperAdminEnum;
import smhs.modules.timbre.service.TimbreService;
...
public class AgentServiceImpl extends BaseServiceImpl<AgentDao, AgentEntity> implements AgentService {
    ...
    @Override
    public AgentEntity getDefaultAgentBySsid(String ssid) {
        if (StringUtils.isEmpty(ssid)) {
            return null;
        }
        return agentDao.getDefaultAgentBySsid(ssid);
    }
    ...
    public void updateAgentById(String agentId, AgentUpdateDTO dto) {
        ...
        if (dto.getGreetingMessage() != null) {
            existingEntity.setGreetingMessage(dto.getGreetingMessage());
        }
        if (dto.getLeaveMessage() != null) {
            existingEntity.setLeaveMessage(dto.getLeaveMessage());
        }
     ...
     */
    @Override
    public GreetingLeaveMessageVO getGreetingAndLeave(String ssid) {
        DeviceEntity device = deviceService.getDeviceBySsid(ssid);
        if(Objects.isNull(device)){
            throw new RenException(ErrorCode.DEVICE_NO_EXISTS);
        }
        return agentDao.getGreetingAndLeave(device.getAgentId());
    }
}