package smhs.modules.sys.controller;
...
import smhs.common.annotation.LogOperation;
...
import smhs.common.validator.group.AddGroup;
import smhs.common.validator.group.DefaultGroup;
import smhs.common.validator.group.UpdateGroup;
...
import smhs.modules.sys.utils.WebSocketValidator;
...
public class SysParamsController {
    ...
    private void validateMqttSecretLength(String paramCode, String secret) {
        ...
        // 不允许包含弱密码
        String[] weakPasswords = { "test", "1234", "admin", "password", "qwerty", "smhs" };
