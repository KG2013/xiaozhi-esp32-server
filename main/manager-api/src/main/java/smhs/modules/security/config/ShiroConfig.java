package smhs.modules.security.config;
...
import smhs.modules.security.oauth2.Oauth2Filter;
import smhs.modules.security.oauth2.Oauth2Realm;
import smhs.modules.security.secret.ServerSecretFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager, SysParamsService sysParamsService) {
        ...
        filterMap.put("/agent/greetingAndLeave/**", "server");
