...
public interface Constant {
     ...
     * 无效固件URL
     */
    String INVALID_FIRMWARE_URL = "http://smhs.manage.langeving.com/smhs/otaMag/download/NOT_ACTIVATED_FIRMWARE_THIS_IS_A_INVALID_URL";
